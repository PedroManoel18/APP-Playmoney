...
if ($id_categoria <= 0 || $valor <= 0 || $descricao === '' || !in_array($tipo, ['Fixa', 'Variavel'], true) || $data === '') {
    die("Dados inválidos para cadastro de receita.");
}
...
$sql = mysqli_prepare($conn, "INSERT INTO receitas (id_usuario, id_categoria, valor, descricao, tipo, data_lancamento) VALUES (?, ?, ?, ?, ?, ?)");
