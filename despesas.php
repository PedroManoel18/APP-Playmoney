...
$sql = mysqli_prepare($conn, "SELECT id_categoria, nome_categoria FROM categorias WHERE id_usuario = ? AND tipo_categoria = 'Despesa' ORDER BY nome_categoria");
...
<title>Despesas | PlayMoney</title>
...
<nav class="navbar navbar-dark bg-danger">
    <div class="container">
        <span class="navbar-brand">💰 Despesas</span>
        <div>
            <a href="dashboard.php" class="btn btn-light">Dashboard</a>
            <a href="listar_despesas.php" class="btn btn-warning">Visualizar Despesas</a>
        </div>
    </div>
</nav>
    ...
    <div class="card shadow">
        <div class="card-body">
            ...
            <form action="salvar_despesa.php" method="POST">
                ...
                <input type="date" name="data_vencimento" class="form-control mb-3" required>
